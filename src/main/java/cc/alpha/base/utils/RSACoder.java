...
public abstract class RSACoder {
   ...
   */
  public static String[] readModulusAndPublicExponent(String key) throws InvalidKeySpecException, NoSuchAlgorithmException, Base64DecodingException{
    ...
    res[0] = Base64.encode(publicKey.getModulus().toByteArray());
    res[1] = Base64.encode(publicKey.getPublicExponent().toByteArray());
    return res;
  }	
}
